...
export const committees: CommitteeData[] = [
  {
    ...
    note: "Note: This committee will assume a timeline which follows real world events up to March 2, 2026. All events post March 2, will constitute a hypothetical and invalid timeline up to the date of the conference, 28 July, 2026. The details for the same will be mentioned in the background guide.",
    chairLetter: [
      "Dear Delegates,",
      ...
      "This year, the Security Council was faced with the spark of events beginning on March 2nd, 2026, two days after Iran's Supreme leader Ali Hosseini Khamenei was assassinated and the very day when Iranian authorities officially blockaded the Strait of Hormuz for international maritime traffic. Following almost five entire months of upheaval, fear has turned to reality; the dynamics of the region have completely changed, and we will now stand on the precipice of a full-scale, multi-front war that threatens the very existence of many nations on the map.",
