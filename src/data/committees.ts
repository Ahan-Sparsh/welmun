...
export const committees: CommitteeData[] = [
  {
    ...
    eb: [
      ...
      { name: "Aditya Raj Yadav", role: "Director", image: "" },
  ...
  },
  {
    ...
    eb: [
      ...
      { name: "Agastya Gupta", role: "Vice Chairperson", image: "" },
      { name: "Chetan Chopra", role: "Director", image: "" },
      { name: "Yuvraj Gupta", role: "Director", image: "" },
