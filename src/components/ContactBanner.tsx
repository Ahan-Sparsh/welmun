      ...
      <div className="mt-auto pt-12 border-t border-blue-accent/20">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          <div className="flex gap-5 items-center">
            ...
            <a href="https://in.linkedin.com/school/welham-boys-school/" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-blue-accent transition-colors cursor-none">
              <Linkedin className="w-6 h-6" />
            </a>
            <a href="https://www.youtube.com/channel/UCQ_6roDP5aOZ99QdrjGVsHA" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-blue-accent transition-colors cursor-none">
