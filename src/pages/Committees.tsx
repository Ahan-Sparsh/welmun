...
const committees: Committee[] = [
  ...
  },
  {
    id: "loksabha",
    name: "Lok Sabha",
    logo: "https://static.wixstatic.com/media/9bbbe8_4b2339bb80a54032b57341a8e1147ae5~mv2.png/v1/fill/w_288,h_264,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/Lok_Sabha_Logo-removebg-preview%20(1)_edit.png",
    agenda: "Assessing the Feasibility of 'One Nation, One Election' in India and its Implications on Federal Autonomy.",
    chairLetter: [
      "\"Every revolution begins with the power of an idea. That idea must shake the foundations of the present.\" — Jayaprakash Narayan",
      "Chaos breeds destruction. But destruction? That's just the prelude to something greater—Rebirth. India that is Bharat, a holding together nation has come through an intricate web of diversity, has always found strength in its contradictions.",
      "The agenda before us isn't just a policy dilemma. It's a test of vision, pragmatism, and courage. It's about questioning whether the quest for efficiency undermines the essence of federalism or strengthens the nation's core.",
    ],
    chairName: "Atharva Agrawal",
    chairRole: "Speaker",
    chairEmail: "speaker.loksabha@welhamboys.org",
    bgLink: "https://www.welhammun.org/_files/ugd/9bbbe8_c8a9f4d0610047d99ae45d07efc79b42.pdf",
    matrixLink: "https://www.welhammun.org/_files/ugd/9bbbe8_3b93ac30378e40969c84092edc47a200.pdf",
    ropLink: "https://www.welhammun.org/_files/ugd/9bbbe8_c88b01284290412999cab6e0550ea0a3.pdf",
    eb: [
      { name: "Atharva Agrawal", role: "Speaker", image: "https://static.wixstatic.com/media/9bbbe8_f9658fe643884e50a6c9ccdb57c08b66~mv2.jpg/v1/crop/x_0,y_162,w_1878,h_1878/fill/w_278,h_278,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/IMG_5602_edited.jpg" },
      { name: "Devvardhan Agarwal", role: "Deputy Speaker", image: "https://static.wixstatic.com/media/9bbbe8_1dc335ab0a924bba97b0b28e26d91b15~mv2.png/v1/fill/w_203,h_283,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/IMG_5600_edited_edited_edited.png" },
      { name: "Rudra Rastogi", role: "Director", image: "https://static.wixstatic.com/media/9bbbe8_20ae16cd8c9441fb8d2ef235d33e386c~mv2.jpg/v1/crop/x_0,y_244,w_1550,h_2132/fill/w_193,h_273,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/IMG_5594_edited.jpg" },
      { name: "Hasan Faisal", role: "Director", image: "https://static.wixstatic.com/media/9bbbe8_ef7908c867c94bc28f75dadfb4a4114c~mv2.jpg/v1/crop/x_226,y_1349,w_2923,h_4023/fill/w_193,h_273,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/WBS07428_JPG.jpg" },
...
const CommitteeSection = ({ committee }: { committee: Committee }) => (
  <section id={committee.id} className="w-full max-w-5xl mb-24 scroll-mt-24">
    <div className="flex flex-col md:flex-row items-start gap-8 mb-8">
      <img src={committee.logo} alt={committee.name} className="w-40 h-auto shrink-0" />
      <div>
        <h2 className="font-display text-3xl md:text-4xl text-primary mb-3">{committee.name}</h2>
        {committee.agenda && (
    ...
    <div className="space-y-4 text-muted-foreground leading-relaxed mb-8">
      ...
      <p className="mt-4">
        {committee.chairName}<br />
        {committee.chairRole}, {committee.name}<br />
        <a href={`mailto:${committee.chairEmail}`} className="text-primary hover:underline cursor-none">
    ...
    <div className="flex flex-wrap gap-3 mb-8">
      {committee.bgLink && (
        <a href={committee.bgLink} target="_blank" rel="noopener noreferrer"
          className="px-5 py-2 border border-primary text-primary text-sm hover:bg-primary hover:text-primary-foreground transition-colors cursor-none">
          Background Guide
        </a>
      )}
    ...
    <h3 className="font-display text-2xl text-primary mb-6">Executive Board</h3>
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
      {committee.eb.map((member) => (
        <div key={member.name} className="flex flex-col items-center text-center gap-2">
          <img src={member.image} alt={member.name} className="w-32 h-32 object-cover rounded" />
...
const Committees = () => (
  <PageLayout>
    <h1 className="font-display text-5xl text-primary mb-4">Committees</h1>
    ...
    <div className="flex flex-wrap gap-3 mb-16 justify-center">
      {committees.map((c) => (
        <a key={c.id} href={`#${c.id}`}
          className="px-4 py-2 border border-primary/30 text-primary text-sm hover:bg-primary hover:text-primary-foreground transition-colors cursor-none">
          {c.name}
        </a>
      ))}
    </div>
    ...
    {committees.map((c) => (
      <CommitteeSection key={c.id} committee={c} />
    ))}
  </PageLayout>
);
