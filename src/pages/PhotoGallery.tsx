...
const photos = [
  ...
  { src: img("5af336fdc3354706937f1614607cce73"), col: 2, row: 1 },
  { src: img("8584d04d3df64a40b3646d27fcbf7c3e"), col: 1, row: 1 },
  { src: img("eff82fe1ad1b4705b550ecaee42fb01c"), col: 1, row: 2 },
  { src: img("9aef4a3e0f0240d191109e26b0ce46a8"), col: 2, row: 2 },
  { src: img("a17fb0f3e6fe43788eb0d86f80c66fc0"), col: 1, row: 1 },
  { src: img("458670694d414807a39aa923af803359"), col: 2, row: 1 },
  { src: img("d93efe9445fe4cf6a412c68b2a0fa6e7"), col: 1, row: 2 },
  { src: img("36835ba8639c4c0b9b70a56d760b44b1"), col: 1, row: 1 },
  { src: img("642d56efce8c4a53bd4d8e4ee1a9757e"), col: 2, row: 2 },
  { src: img("d2c71b02089e4516bee57c105f5dd04a"), col: 1, row: 1 },
  { src: img("224d9ea4750f40258d63f3b3812206f2"), col: 1, row: 2 },
  { src: img("8712f366361c4117b7ad6506cdd6b9ac"), col: 2, row: 1 },
  { src: img("aa52070a1a2948148fb5ebdab561998b"), col: 1, row: 1 },
  ...
  { src: img("3447d9f926864e85823f1cde9f5c0f99"), col: 2, row: 1 },
  ...
  { src: img("6c3251442462499ca55d859d965dbc26"), col: 1, row: 2 },
  { src: img("9ac0f0ea32db4bbcb854fa6fe4673ea9"), col: 2, row: 2 },
