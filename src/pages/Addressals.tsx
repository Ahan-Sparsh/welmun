...
const addressals: Addressal[] = [
  ...
  },
  {
    ...
    body: [
      "The first thought that came to my mind when I sat down to write this was a simple one: \"Why does chaos bother us so much?\" Individuals may think it's because conflicts obstruct livelihoods, or because it breaks systems, that it brings about disorder; essentially, it negatively affects us. Though this is completely true, I don't think this is the core reason. This answer, I believe, is rather trivial: chaos bothers us not because it brings disorder, but because it takes away control, the ability to comprehend what comes next, to know how the environment around us is likely to evolve. We are taught, directly and indirectly, to seek order, to trust certainty, and to believe that order is something permanent and dependable, and when this certainty is taken away, we long to restore it.",
      "Unfortunately, the world seldom works that way.",
